              ...
              <div class="card card-warning">
                ...
                {{--  <form >  --}}
                  ...
                  <div class="card-body">
                    ...
                    {{Form::text('description1', $sliders->description1, ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' => 'Enter description one'])}}
                    </div>
                    <div class="form-group">
                    ...
                    {{Form::text('description2', $sliders->description2, ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' => 'Enter description one'])}}
                    </div>
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        {{Form::file('slider_image', ['class' => 'custom-file-input', 'id' => 'exampleInputFile', 'placeholder' => 'Entrer product price'])}}
