            ...
            <div class="col-lg-12 d-block">
                <div class="row d-flex">
                    <div class="col-md pr-4 d-flex topper align-items-center">
                        ...
                        <span class="text">+ 224 628 568 469</span>
                    </div>
                    <div class="col-md pr-4 d-flex topper align-items-center">
                        <div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
                        <span class="text">darionarious92@gmail.com</span>
                    </div>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="{{ '/connecter' }}" class="nav-link">Admin</a></li>
          @else
            <li class="nav-item active"><a href="{{('/disconnected')}}" class="nav-link">Ad</a></li>
          @endif
