	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('frontend/login/images//bg-01.jpg');">
			<div class="wrap-login100">
				<form action="{{url('/acceder_compt')}}" method="POST" class="login100-form validate-form">
					<a href="{{url('/')}}">
                        {{ csrf_field() }}
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter votre nom">
						<input class="input100" type="text" name="nom" placeholder="Nom">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>

                    <div class="wrap-input100 validate-input" data-validate = "Enter votre prénom">
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="{{ '/connecter' }}">
							N'avez-vous pas de compte ? Se Connecter
						</a>
					</div>
				</form>
			</div>
