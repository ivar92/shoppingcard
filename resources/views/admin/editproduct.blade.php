              ...
              <div class="card card-success">
                ...
                {{--  <form id="quickForm">  --}}
                  ...
                  <div class="card-body">
                    ...
                    {{Form::text('product_name', $product->product_name, ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' => 'Entrer product'])}}
                    </div>
                    <div class="form-group">
                    ...
                    {{Form::number('product_price', $product->product_price, ['class' => 'form-control', 'id' => 'exampleInputEmail1', 'placeholder' => 'Entrer product price'])}}
                    </div>
                    <div class="form-group">
